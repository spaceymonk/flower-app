    ...
    <Modal show={show} size="lg" centered onHide={onClose} scrollable>
      ...
      <Modal.Body className="pb-2">
        <Container className="text-center">
          ...
          <p className="text-center mx-sm-5">
            This project developed by Berktuğ Kaan Özkan (<a href="http://spaceymonk.github.io/">@spaceymonk</a>). You can find the source code on{' '}
            <a href="https://github.com/spaceymonk/flower-app">GitHub page</a>.
            FlowerApp icon made by <a href="https://instagram.com/i.tasted.purple">Savaş Şen</a>.
          </p>
        </Container>
      </Modal.Body>
      <Modal.Footer>
